 ...
 * Formulas use clean Unicode — no LaTeX dependency required.
 */
...
export const physicsTopics = [
  ...
  },
  {
    ...
    keyConcepts: [
      "Scalar product formulation of Work (W = F d cosθ)",
  ...
  },
  {
    ...
    keyConcepts: [
      ...
      "Moment of Inertia I = Σ m_i r_i² for disks, spheres, and rods",
  ...
  },
  {
    ...
    keyConcepts: [
      ...
      "Radioactive decay law, half-life (T₁/₂), and decay constant",
